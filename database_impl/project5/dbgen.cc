	...
	if(argc == 2 || argc == 4) {
		...
		if(argc == 2) {
			if(argv[1] == string("-all")) {
				...
				string defaultPath = userHome + "/Database/sqlite/";
				...
				if(yn == "Y" || yn == "y") {
					...
					// preparing
					int size = 8;
					vector<string> tableNames = {"customer", "lineitem", "nation", "orders", "part", "partsupp", "region", "supplier"};
					/*vector<string> tableNames;
					cout<<"what's wrong"<<endl;
					tableNames[0] = "customer";
					tableNames[1] = "lineitem";
					tableNames[2] = "nation";
					tableNames[3] = "orders";
					tableNames[4] = "part";
					tableNames[5] = "partsupp";
					tableNames[6] = "region";
					tableNames[7] = "supplier";*/
		...
		cout << endl;
		cout << "This simple program generates a DBFile from TPC-H data." << endl << endl;
		cout << "Usage: " << endl;
